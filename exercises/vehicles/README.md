...
A user complains that the countries are not ordere alphabetically when they execute `python vehicles show imports`. 
...
Another user complaints that `python vehicles show top` is slow in production.
